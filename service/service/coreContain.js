...
function addProduct(_symbol, _id, _coinbase, _number)
{
	return new Promise(function(resolve, reject)
	{
		...
		txParams.sc.nameFunc = 'addProduct';
...
function subProduct(_symbol, _id, _value)
{
	return new Promise(function(resolve, reject)
	{
		function checktransaction(data)
...
function getIdProduct(_symbol, _i)
{
	return new Promise(function(resolve, reject){
...
function getAllIdProduct(_symbol)
{
	return new Promise(function(resolve, reject) {
		var arr = [];
		var end = false;
